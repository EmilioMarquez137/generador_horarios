...
<div class="container">
<section class="tabs">
    <button class="tab-button active" onclick="openTab(event, 'profesores')">Profesor</button>
    <button class="tab-button" onclick="openTab(event, 'clases')">Clase</button>
    <button class="tab-button" onclick="openTab(event, 'grupos')">Aula</button>
</section>
...
<section id="profesores" class="tab-content">
    ...
    <form>
        ...
        <button class="send-button" type="submit">Añadir Profesor</button>
    </form>
</section>

<section id="clases" class="tab-content" style="display:none;">
    <h2>Añadir Clases</h2>
    <form>
        ...
        <button class="send-button" type="submit">Añadir Clase</button>
        ...
        <button class="send-button" type="button" onclick="agregarDiaHora()">Añadir Día y Hora</button>
        <div id="dias-horas-clase"></div>
        
    </form>
</section>

<section id="grupos" class="tab-content" style="display:none;">
    <h2>Añadir Grupos</h2>
    <form>
        ...
        <button class="send-button" type="submit">Añadir Grupo</button>
    </form>
</section>
</div>
